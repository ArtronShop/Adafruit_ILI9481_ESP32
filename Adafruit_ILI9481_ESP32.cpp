...
-----------
*/
#include <Adafruit_ILI9481_ESP32.h>

/*****************************************************************************/
Adafruit_ILI9481_ESP32::Adafruit_ILI9481_ESP32(void) : Adafruit_GFX(TFTWIDTH, TFTHEIGHT){}
/*****************************************************************************/
void writebus(uint8_t d) {
	...
	/*GPIO.out_w1ts = 
		((d&0x01)<<TFT_D0) | (((d>>1)&0x01)<<TFT_D1) | (((d>>2)&0x01)<<TFT_D2) | (((d>>3)&0x01)<<TFT_D3) |
		(((d>>4)&0x01)<<TFT_D4) | (((d>>5)&0x01)<<TFT_D5) | (((d>>6)&0x01)<<TFT_D6) | (((d>>7)&0x01)<<TFT_D7);
	...
	GPIO.out_w1tc = ((uint32_t)1 << TFT_WR); // Set
	GPIO.out_w1ts = ((uint32_t)1 << TFT_WR); // Cls
}
/*****************************************************************************/
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::begin(void)
{
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::setAddrWindow(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1)
{
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::pushColor(uint16_t color)
{
	writedata16(color);
}
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::drawPixel(int16_t x, int16_t y, uint16_t color)
{
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color)
{
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color)
{
	// Rudimentary clipping
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::fillScreen(uint16_t color) {
	setAddrWindow(0, 0,  _width - 1, _height - 1);
	writedata16(color, (_width * _height));
}

/*****************************************************************************/
void Adafruit_ILI9481_ESP32::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
...
*/
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::drawLine(int16_t x0, int16_t y0,int16_t x1, int16_t y1, uint16_t color)
{
...
/*****************************************************************************/
uint16_t Adafruit_ILI9481_ESP32::color565(uint8_t r, uint8_t g, uint8_t b)
{
  return ((r & 0xF8) << 8) | ((g & 0xFC) << 3) | (b >> 3);
}
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::setRotation(uint8_t m)
{
...
/*****************************************************************************/
void Adafruit_ILI9481_ESP32::invertDisplay(boolean i)
{
